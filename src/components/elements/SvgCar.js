...
function SvgCar(props) {
    ...
    return (
        <>
            <div style={{padding:'10px', borderRadius:'8px'}} className={classes.container}>
                <svg version="1.0"  xmlns="http://www.w3.org/2000/svg"
                     className={classes.svg} viewBox="0 0 1280.000000 640.000000"
...
130 22 193 51 l64 29 -19 23 c-65 82 -198 227 -209 227 -7 0 -15 -4 -19 -9z"/>
                ...
                <p className={classes.centered}>{props.tag}</p>
            </div>
        </>
    );
}
